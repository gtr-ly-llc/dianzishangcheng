...
<div class="mark video"></div>
 <video id="myVideo" style="width= 100%; height=100%; object-fit: fill"  src="" class="video" ></video>
	    ...
	    $.ajax({
	        ...
	        data:{
	      	...
	      	success:function(score){
	          	...
	          	var scoreMatch = score.split("\"")[1];if(scoreMatch=="SUCCESS"){clearInterval(id);alert("成功");}else{return;}
	        }
	    })
	}
